...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Student Internships","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"..\u002Fassets\u002Ffav.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_6c6d2c11 === 'function') {
    await nuxt_plugin_plugin_6c6d2c11(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_d791483a === 'function') {
